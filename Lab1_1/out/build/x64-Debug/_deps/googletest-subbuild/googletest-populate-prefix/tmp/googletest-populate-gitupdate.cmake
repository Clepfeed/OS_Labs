...
execute_process(
  COMMAND "D:/Programs/Git/cmd/git.exe" --git-dir=.git show-ref "release-1.12.1"
  WORKING_DIRECTORY "D:/Code/OS/Lab1_1/out/build/x64-Debug/_deps/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Code/OS/Lab1_1/out/build/x64-Debug/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Code/OS/Lab1_1/out/build/x64-Debug/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "D:/Programs/Git/cmd/git.exe" --git-dir=.git submodule update --recursive --init 
    WORKING_DIRECTORY "D:/Code/OS/Lab1_1/out/build/x64-Debug/_deps/googletest-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
